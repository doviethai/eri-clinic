...
class Eri_Clinic_Footer_Columns extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'eri_clinic_menu_footer_column', /* Base ID */
            'Eri - Menu Footer Column', /* Name */
            array( 'description' => __( 'Eri - Menu Footer Column', ERI_LIB_DIR ), ) /* Args */
        );
    }
