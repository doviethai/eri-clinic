					...
					<ul style="display: none;">
						...
						<ul id="slider-unique-options-list" >
							<li>
								<?php
								$types = array(
									"slider_01" => __("Type One"),
									"slider_02" => __("Type Two"),
									"slider_03" => __("Type Three"),
									"slider_04" => __("Type Four"),
									"slider_05" => __("Type Five"),
									"slider_06" => __("Type Six"),
									"slider_07" => __("Slider Face Home Page"),
									"slider_08" => __("Type Eight"),
									"slider_09" => __("Type Nine"),
									"slider_10" => __("Type Page Menu Prod"),
									"slider_11" => __("Slider 01 Home Japan"),
									"slider_12" => __("Slider Service VN "),
									"slider_13" => __("Slider History"),
									"slider_15" => __("Slider Page for Men"),									
								);
								?>
								<label for="slider_template">Slider Template</label>
								<select id="slider_template" class="" name="template">
									<?php foreach($types as $key => $value):?>
										<option <?php if($row->template == $key){ echo "selected=\"selected\""; } ?> value="<?php echo $key;?>"><?php echo $value;?></option>
									<?php endforeach;?>
								</select>
							</li>
						</ul>
