...
<div id="huge_it_slider">
  <?php
	  ...
	  if($_GET["hugeit_save"]==1){
			...
			$wpdb->query("UPDATE ".$wpdb->prefix."huge_itslider_sliders SET  template = '".$_POST["template"]."'  WHERE id = '".$id."' ");
		}
		}
...
class Huge_it_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			...
			?>
				<option <?php if(isset($instance['slider_id']) && $rowwidgetecho->id == $instance['slider_id']){ echo 'selected'; } ?> value="<?php echo $rowwidgetecho->id; ?>">
					<?php echo $rowwidgetecho->name; ?>
				</option>
			<?php } ?>
			</select>
		</p>
...
INSERT INTO `$table_name` (`id`, `name`, `sl_height`, `sl_width`, `pause_on_hover`, `slider_list_effects_s`, `description`, `param`, `ordering`, `published`, `template`) VALUES
(1, 'My First Slider', '375', '600', 'on', 'random', '4000', '1000', '1', '300', 1)";
