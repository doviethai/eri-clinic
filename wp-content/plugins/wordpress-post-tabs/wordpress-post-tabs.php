...
//on activation, your WordPress Post Tabs options will be populated. Here a single option is used which is actually an array of multiple options
    ...
    function wpts_edit_custom_box()
    {
        ...
        ?>
        <p><input type="checkbox" id="enablewpts" name="enablewpts" value="1" <?php echo $checked;?> />&nbsp;<label
                for="enablewpts"><strong>Enable WP Post Tabs Feature</strong></label></p>
    <?php
    }
    ...
    function wpts_end_shortcode($atts)
    {
        ...
        global $wpts_content, $wpts_tab_count;


        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $first = false;
        $tabHtml = "<div class=\"panel-group\" id=\"accordion\" role=\"tablist\" aria-multiselectable=\"true\">";
        for ($i = 0; $i < $wpts_tab_count; $i++) {
            if(!isset($wpts_content[$i]['name'])) continue;
            if($first){
                $classOpen = "in";
                $first = false;
            }else{
            ...
            $tabHtml .= "<div id=\"headingOne\" class=\"panel-heading\">";
            $tabHtml .= "<h4 class=\"panel-title\">";
            $tabHtml .= "<a class=\"yt-toggle\" href=\"#collapseOne$i\" data-toggle=\"collapse\"  data-parent=\"#accordion\">";
            $tabHtml .= $wpts_content[$i]['name'];
            $tabHtml .= "<i class=\"fa fa-caret-down fa-fw fa-rotate-180\"></i>";
            $tabHtml .= "<i class=\"fa fa-caret-down fa-fw\"></i>";
            $tabHtml .= "</a>";
            $tabHtml .= "</h4>";
            $tabHtml .= "</div>";
            $tabHtml .= "<div id=\"collapseOne$i\" class=\"panel-collapse collapse $classOpen\">";
            $tabHtml .= "<div class=\"panel-body\">";
            $tabHtml .= $wpts_content[$i]['content'];
            $tabHtml .= "</div>";
            $tabHtml .= "</div>";
            $tabHtml .= "</div>";
        }
        ...
        if ($css and !empty($css)) {
            if ((is_admin() and isset($_GET['page']) and 'wordpress-post-tabs.php' == $_GET['page']) or !is_admin()) { ?>
                <script type="text/javascript">jQuery(document).ready(function () {
                        jQuery("head").append("<style type=\"text/css\"><?php echo $css;?></style>");
                    }) </script>
            <?php }
        }
    }
    ...
    function wpts_settings_page()
    {
        ...
        <div class="wrap">
            ...
            <div style="width:65%;margin-top: 15px;margin-bottom: 20px;">
                <div style="float:right;"><strong style="color:#ccc;font-size:9px;">powered by</strong> <a
                        style="margin-left:5px;" href="http://tabbervilla.com/" target="_blank" rel="nofollow"><img
                            src="<?php echo wpts_plugin_url('images/tabbervilla.png'); ?>" width="120"/></a></div>
                                ...
                                <div>
                                    <table class="form-table">
                                        ...
                                        <tr valign="top" class="row">
                                            <th scope="row"><label
                                                    for="wpts_options[stylesheet]"><?php _e('Skin/Style', 'wpts'); ?></label>
                                            </th>
                                            <td><select name="wpts_options[stylesheet]" id="wpts_stylesheet">
                                                    ...
                                                    if ($handle = opendir($directory)) {
                                                        while (false !== ($file = readdir($handle))) {
                                                            if ($file != '.' and $file != '..') { ?>
                                                                <option
                                                                    value="<?php echo $file; ?>" <?php if ($wpts['stylesheet'] == $file) {
                                                                    echo "selected";
                                                                } ?> ><?php echo str_replace("_", " ", $file); ?></option>
                                                            <?php }
                                                        }
                                                        closedir($handle);
                                                    }
                                        ...
                                        <tr valign="top" class="row even">
                                            <th scope="row"><label
                                                    for="wpts_options[fade]"><?php _e('\'Fade\' effect', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[fade]" type="checkbox" id="wpts_options_fade"
                                                       value="1" <?php checked("1", $wpts['fade']); ?> /></td>
                                        </tr>

                                        <tr valign="top" class="row">
                                            <th scope="row"><label
                                                    for="wpts_options[enable_everywhere]"><?php _e('Enable tabs Sitewide', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[enable_everywhere]" type="checkbox"
                                                       id="wpts_options_enable_everywhere"
                                                       value="1" <?php checked("1", $wpts['enable_everywhere']); ?> />
<span class="moreInfo">
	...
	<div class="tooltip">
        <?php _e('Enable tabs on archives, index and all other templates', 'wpts'); ?>
                                        ...
                                        <tr valign="top" class="row even">
                                            <th scope="row"><label
                                                    for="wpts_options[enablecookie]"><?php _e('Enable Cookie for last active tab', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[enablecookie]" type="checkbox"
                                                       id="wpts_options_enablecookie"
                                                       value="1" <?php checked("1", $wpts['enablecookie']); ?> />
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
        <?php _e('If checked last active tab will open by default', 'wpts'); ?>
                                        ...
                                        <tr valign="top" class="row">
                                            <th scope="row"><label
                                                    for="wpts_options[prettylinks]"><?php _e('Enable prettylinks for tab #', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[prettylinks]" type="checkbox"
                                                       id="wpts_options_prettylinks"
                                                       value="1" <?php checked("1", $wpts['prettylinks']); ?> />
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
        <?php _e('If checked the tab names will be used as tab # urls instead of #tab-112-...', 'wpts'); ?>
                                        ...
                                        <tr valign="top" class="row even">
                                            <th scope="row"><label
                                                    for="wpts_options[nav]"><?php _e('Navigation', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[nav]" type="checkbox" id="wpts_options_nav"
                                                       value="1" <?php checked("1", $wpts['nav']); ?> />
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
        <?php _e('Enable Navigation Links', 'wpts'); ?>
                                        ...
                                        <tr valign="top" class="row">
                                            <th scope="row"><label
                                                    for="wpts_options[next_text]"><?php _e('\'Next\' navigation text', 'wpts'); ?></label>
                                            </th>
                                            <td><input type="text" name="wpts_options[next_text]"
                                                       id="wpts_options_next_text" class="regular-text code"
                                                       value="<?php echo $wpts['next_text']; ?>"/>
                                            </td>
                                        </tr>

                                        <tr valign="top" class="row even">
                                            <th scope="row"><label
                                                    for="wpts_options[prev_text]"><?php _e('\'Prev\' navigation text', 'wpts'); ?></label>
                                            </th>
                                            <td><input type="text" name="wpts_options[prev_text]"
                                                       id="wpts_options_prev_text" class="regular-text code"
                                                       value="<?php echo $wpts['prev_text']; ?>"/></td>
                                        </tr>

                                        <tr valign="top" class="row">
                                            <th scope="row"><label
                                                    for="wpts_options[linktarget]"><?php _e('Open tab links in New window', 'wpts'); ?> </label>
                                            </th>
                                            <td><input name="wpts_options[linktarget]" type="checkbox"
                                                       id="wpts_options_linktarget"
                                                       value="1" <?php checked("1", $wpts['linktarget']); ?> />
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
        <?php _e('This checkbox should be checked when you are linking the tab to an External Link and would want to open that link in a new window.', 'wpts'); ?>
                                        ...
                                        <tr valign="top" class="row even">
                                            <th scope="row"><label
                                                    for="wpts_options[reload]"><?php _e('Reload on click', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[reload]" type="checkbox"
                                                       id="wpts_options_reload"
                                                       value="1"  <?php checked("1", $wpts['reload']); ?> />
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
        <?php _e('This may increase your pageviews.', 'wpts'); ?>
                                        ...
                                        <tr valign="top" class="row">
                                            <th scope="row"><label
                                                    for="wpts_options[showtitle]"><?php _e('Title Attribute for tab links', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[showtitle]" type="checkbox"
                                                       id="wpts_options_showtitle"
                                                       value="1" <?php checked("1", $wpts['showtitle']); ?> />
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
        <?php _e('If you want title attribute to be displayed when the user hovers on Tab Title.', 'wpts'); ?>
                                        ...
                                        <tr valign="top" class="row even">
                                            <th scope="row"><label
                                                    for="wpts_options[disable_fouc]"><?php _e('Disable FOUC', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[disable_fouc]" type="checkbox"
                                                       id="wpts_options_disable_fouc"
                                                       value="1" <?php checked("1", $wpts['disable_fouc']); ?> />
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
        <?php _e('If you disable FOUC i.e. Flash Of Unstyled Content, tabs may not be displayed on the browser on which Javascript is disabled.', 'wpts'); ?>
                                        ...
                                        <tr valign="top" class="row">
                                            <th scope="row"><label
                                                    for="wpts_options[jquerynoload]"><?php _e('Disable \'jquery\'', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[jquerynoload]" type="checkbox"
                                                       id="wpts_options_jquerynoload"
                                                       value="1" <?php checked("1", $wpts['jquerynoload']); ?> />
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
                            ...
                            <h3 class="hndle" style="font-size: 18px;"><?php _e('Advanced Options', 'wpts'); ?></h2>
                                ...
                                <div style="padding:10px">
                                    ...
                                    <table class="form-table">
                                        <tr valign="top">
                                            <th scope="row"><label
                                                    for="wpts_options[posts]"><?php _e('Disable resources on all Posts', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[posts]" type="checkbox"
                                                       id="wpts_options_posts"
                                                       value="0" <?php checked("0", $wpts['posts']); ?> />
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
        <?php _e('You would get a custom box on your edit post panel to enable tabs on that particular post.', 'wpts'); ?>
                                        ...
                                        <tr valign="top">
                                            <th scope="row"><label
                                                    for="wpts_options[pages]"><?php _e('Disable resources on all Pages', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[pages]" type="checkbox"
                                                       id="wpts_options_pages"
                                                       value="0" <?php checked("0", $wpts['pages']); ?>  />
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
        <?php _e('You would get a custom box on your edit page panel to enable tabs on that particular page.', 'wpts'); ?>
                                ...
                                <div style="padding:10px">
                                    <small><?php _e('The default shortcodes are [wptab] for adding a tab and [end_wptabset] to end particular set/group of tabs. Do not use spaces in the custom shortcodes. To check how to insert the tabs in your post/page, please refer the', 'wpts'); ?>
                                        <a href="http://guides.tabbervilla.com/wordpress-post-tabs/"><?php _e('plugin guide', 'wpts'); ?></a>.
                                    </small>
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr valign="top">
                                            <th scope="row"><label
                                                    for="wpts_options[tab_code]"><?php _e('Replace [wptab] shortcode with', 'wpts'); ?></label>
                                            </th>
                                            <td>[<input type="text" name="wpts_options[tab_code]"
                                                        id="wpts_options_tab_code"
                                                        value="<?php echo $wpts['tab_code']; ?>"/>]
                                                <small> &nbsp;
                                                    &nbsp; <?php _e('(For example, you can enter: mytabs)', 'wpts'); ?></small>
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            <th scope="row"><label
                                                    for="wpts_options[tab_end_code]"><?php _e('Replace [end_wptabset] shortcode with', 'wpts'); ?></label>
                                            </th>
                                            <td>[<input type="text" name="wpts_options[tab_end_code]"
                                                        id="wpts_options_tab_end_code"
                                                        value="<?php echo $wpts['tab_end_code']; ?>"/>]
                                                <small> &nbsp;
                                                    &nbsp; <?php _e('(For example, you can enter: end_mytabs)', 'wpts'); ?></small>
                                            </td>
                                        </tr>
                                ...
                                <div style="padding:10px">
                                    <table class="form-table">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td><textarea name="wpts_options[css]" rows="5" cols="32"
                                                          class="regular-text code"><?php echo $wpts['css']; ?></textarea>
<span class="moreInfo">
	&nbsp; <span class="trigger"> ? </span>
	<div class="tooltip">
        <?php _e('custom css styles that you would want to be applied to the tab  elements.', 'wpts'); ?>
                                        ...
                                        <tr valign="top">
                                            <th scope="row"><label
                                                    for="wpts_options[support]"><?php _e('Promote WordPress Post Tabs WP Plugin', 'wpts'); ?></label>
                                            </th>
                                            <td><input name="wpts_options[support]" type="checkbox"
                                                       id="wpts_options_support"
                                                       value="1"  <?php checked("1", $wpts['support']); ?> /></td>
                                        </tr>
                        ...
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <div class="right_panel_link">
                                    <ul>
                                        <li><a href="http://tabbervilla.com/wordpress-post-tabs/"
                                               title="<?php _e('WordPress Post Tabs Homepage', 'wpts'); ?>"><?php _e('Plugin Homepage', 'wpts'); ?></a>
                                        </li>
                                        <li><a href="http://keencodes.com/"
                                               title="<?php _e('WordPress Post Tabs Author Page', 'wpts'); ?>"><?php _e('About the Author', 'wpts'); ?></a>
                                        </li>
                                        <li><a href="http://tabbervilla.com"
                                               title="<?php _e('Visit TabberVilla', 'wpts'); ?>
"><?php _e('Plugin Parent Site', 'wpts'); ?></a></li>
                                        <li><a href="http://www.clickonf5.org/go/donate-wp-plugins/"
                                               title="<?php _e('Donate if you liked the plugin and support in enhancing WordPress Post Tabs and creating new plugins', 'wpts'); ?>"><?php _e('Donate with Paypal', 'wpts'); ?></a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="right_panel_img">
                                    <a style="margin-top:20px;float:right;"
                                       href="http://www.clickonf5.org/go/donate-wp-plugins/" target="_blank"
                                       rel="nofollow"><img src="https://www.paypal.com/en_US/i/btn/btn_donateCC_LG.gif"
                                                           width="100%"/></a>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div style="margin:0 auto 15px auto;">
                            <a href="http://tabbervilla.com/wordpress-post-tabs-pro"
                               title="WordPress Post Tabs PRO plugin" target="_blank"><img
                                    src="<?php echo wpts_plugin_url('images/tabbervilla-ad-300x250.jpg'); ?>"
                                    alt="WordPress Post Tabs PRO plugin" width="100%"/></a>
                        </div>
...
// Hook for adding admin menus
    ...
    function register_wpts_settings()
    { // whitelist options
