...
* **Fixes**
    ...
    * Fixed an issue that led to deleting a post translation also triggering the deleting of the original
    * Removed sending site's url to the ICanLocalize server during first activation
    * Fixed an issue with removing a language from the active languages not triggering a recount of posts
