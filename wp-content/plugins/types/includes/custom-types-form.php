...
//            'alphanumeric' => array('value' => 'true'),
    ...
    $form['name-en'] = array(
        '#type' => 'textfield',
        '#name' => 'ct[labels][name-en]',
        '#title' => __( 'Title En', 'wpcf' ) . ' (<strong>' . __( 'required',
                'wpcf' ) . '</strong>)',
        '#description' => '<strong>' . __( 'Enter in title!', 'wpcf' )
        . '</strong><br />'
//        . __('Alphanumeric with whitespaces only', 'wpcf')
        . '.',
        '#value' => isset( $ct['labels']['name-en'] ) ? $ct['labels']['name-en'] : '',
        '#validate' => array(
            'required' => array('value' => 'true'),
//            'alphanumeric' => array('value' => 'true'),
        ),
    ...
    $form['name-vi'] = array(
        '#type' => 'textfield',
        '#name' => 'ct[labels][name-vi]',
        '#title' => __( 'Title Vi', 'wpcf' ) . ' (<strong>' . __( 'required',
                'wpcf' ) . '</strong>)',
        '#description' => '<strong>' . __( 'Enter in title!', 'wpcf' )
        . '</strong><br />'
//        . __('Alphanumeric with whitespaces only', 'wpcf')
        . '.',
        '#value' => isset( $ct['labels']['name-vi'] ) ? $ct['labels']['name-vi'] : '',
        '#validate' => array(
            'required' => array('value' => 'true'),
//            'alphanumeric' => array('value' => 'true'),
        ),
